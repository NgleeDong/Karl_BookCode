...
- 10.14---lc940. 不同的子序列 II(hard)
- 10.15---lc1441. 用栈操作构建数组
- 10.16---lc886. 可能的二分法
- 10.17---lc904. 水果成篮(滑动窗口)
- 10.18---lc902. 最大为 N 的数字组合（数位dp是什么鬼？）
- 10.19---lc1700. 无法吃午餐的学生数量
- 10.20---lc779. 第K个语法符号
- 10.21---lc901. 股票价格跨度
- 10.22---lc1235. 规划兼职工作（hard、dp 目前做起来有点困难）
- 10.23---lc915. 分割数组
- 10.24---lc1768. 交替合并字符串
- 10.25---lc934. 最短的桥
- 10.26---lc862. 和至少为 K 的最短子数组
- 10.27---lc1822. 数组元素积的符号
- 10.28---lc907. 子数组的最小值之和
- 10.29---lc1773. 统计匹配检索规则的物品数量
- 10.30---lc784. 字母大小写全排列
- 10.31---lc481. 神奇字符串
- 
### 2022.11 每日一题

- 11.1---lc1662. 检查两个字符串数组是否相等
- 11.2---lc1620. 网络信号最好的坐标
- 11.3---lc1668. 最大重复子字符串
- 11.4---lc754. 到达终点数字
- 11.5---lc1106. 解析布尔表达式
- 11.6---lc1678. 设计 Goal 解析器
- 11.7---lc816. 模糊坐标
- 11.8---lc1684. 统计一致字符串的数目
- 11.9---lc764. 最大加号标志
- 11.10---lc864. 获取所有钥匙的最短路径
- 11.11---lc1704. 判断字符串的两半是否相似
- 11.12---lc790. 多米诺和托米诺平铺(不会)
- 11.13---lc791. 自定义字符串排序
- 11.14---lc805. 数组的均值分割（hard，不会）
- 11.15---lc1710. 卡车上的最大单元数
- 11.16---lc775. 全局倒置与局部倒置
- 11.17---lc792. 匹配子序列的单词数
- 11.18---
- 11.19---lc1732. 找到最高海拔
- 11.20---lc799. 香槟塔
- 11.21---lc808. 分汤